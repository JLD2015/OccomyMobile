...
class SendPaymentScreen extends StatefulWidget {
  final String amount;
  const SendPaymentScreen({super.key, required this.amount});

  @override
  State<SendPaymentScreen> createState() => _SendPaymentScreen();
}

class _SendPaymentScreen extends State<SendPaymentScreen> {
  // <========== Variables ==========>
  ...
  void processPayment() async {
    ...
    if (_selectedIndex != -1) {
      ...
      var url = Uri.https('api.occomy.com', 'transact/sendfunds');
